              ...
              <div className="max-w-full overflow-x-auto">
                <Table className="w-full">
                  <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
                    <TableRow>
                      <TableCell isHeader className="px-5 py-3">ID Pengadaan</TableCell>
                      <TableCell isHeader className="px-5 py-3">Tanggal Pengadaan</TableCell>
                  ...
                  <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
                    {pengadaanList.map((item) => (
                      <TableRow key={item.idpengadaan} className="hover:bg-gray-50 dark:hover:bg-white/5">
                        <TableCell className="px-5 py-4">{item.idpengadaan}</TableCell>
                        <TableCell className="px-5 py-4">{item.timestamp}</TableCell>
