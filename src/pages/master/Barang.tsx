...
import { PencilIcon, TrashBinIcon } from "../../icons"; // <-- Pastikan ikon diimpor
...
export default function BarangPage() {
  ...
  return (
    <>
      <PageMeta
        title="Data Barang"
        description="Halaman mengelola data master barang."
      />
                  ...
                  <TableHeader className="border-b border-gray-100 dark:border-white/[0.05] bg-gray-50 dark:bg-gray-800">
                    {filter === "active" ? (
                      <TableRow>
                        <TableCell
                          isHeader
                          className="px-5 py-3 text-xs uppercase font-medium text-gray-500 dark:text-gray-400"
                        >
                          ID
                        </TableCell>
                        <TableCell
                            ...
                            <TableCell className="px-5 py-4 text-sm">
                              <div className="flex justify-center gap-2">
                                <Button
                                  ...
                                  className="!p-1.5"
                                  onClick={() =>
                                    navigate(`/barang/edit/${item.idbarang}`)
                                  }
                                >
                                ...
                                <Button
                                  ...
                                  onClick={() =>
                                    handleDelete(item.idbarang, item.nama)
                                  }
                                >
