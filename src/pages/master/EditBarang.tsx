...
import { fetchSatuanOptions, updateBarangData } from "../../services/DataMasterServices";
import { StatusToko, ViewBarang} from "../../types/data";
    ...
    return (
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="mb-3">
                    ...
                    <select
                        className="border p-2 w-full  dark:bg-gray-800 dark:border-gray-700 dark:text-white" // Contoh styling
